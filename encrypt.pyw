...
decrypt_button = Button(text="Decrypt", pady=10, padx=50, command=lambda:crypting.decrypt_auto(filename_entry.get(), password_entry.get(), 'saltysalt', __file__, True))
encrypt_button = Button(text="encrypt", pady=10, padx=52, command=lambda:crypting.encrypt_auto(filename_entry.get(), password_entry.get(), 'saltysalt', __file__, True))
